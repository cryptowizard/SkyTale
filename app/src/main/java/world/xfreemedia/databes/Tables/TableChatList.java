...
public class TableChatList {
    ...
    public static ChatDAO getChat(SQLiteDatabase db, long chatID) throws ChatHandler.ChatNotFoundExceptoin {
        ...
        {
            throw new ChatHandler.ChatNotFoundExceptoin(new ID(chatID));
        }
