...
public class TableContacts {
        ...
        public static int setContactType(SQLiteDatabase db, String ID, int type) {
            ContentValues contentValues = new ContentValues();
        ...
        public static int updateContact(SQLiteDatabase db, Contact contact) {
            ContentValues contentValues = putContactIntoContentValues(contact);
            return db.update(TableContacts.TABLE_NAME, contentValues, TableContacts.ID + "= '" + contact.contactID + "'", null);
